...
class TechnicianReadService {
    ...
    async getAll() {
        try {
            ...
            const technicians = data && data.response ? data.response : data;
            return { status: 200, data: { technicians } };
        } catch (err) {
    ...
    async getActive(userId) {
        ...
        try {
            ...
            if (!technician) return { status: 404, data: { error: "Technician not found" } };
...
module.exports = TechnicianReadService;
